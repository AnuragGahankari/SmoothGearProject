...
const GarageProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(GarageContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/Garage/update-profile', updateData, { headers: { dToken } })
